    ...
    class Account
      module ClearingNumber
        MAP = {
          ...
          8000..8999 => { name: "Swedbank", type: :bank, serial_number_length: 10, checksum_for_clearing: true, mod11_for_serial: { type: 2, comment: 3 } },
          ...
          9570..9579 => { name: "Sparbanken Syd", type: :bank, serial_number_length: 10, mod11_for_serial: { type: 2, comment: 1 } },
          9590..9599 => { name: "Erik Penser Bankaktiebolag", type: :credit, serial_number_length: 10, mod11_for_serial: { type: 1, comment: 2 } },
          9630..9639 => { name: "Lån og Spar Bank Sverige", type: :loans, mod11_for_serial: { type: 1, comment: 1 } },
          9640..9649 => { name: "NOBA Bank Group AB", type: :savings, mod11_for_serial: { type: 1, comment: 2 } },
